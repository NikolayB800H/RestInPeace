...
VALUES ('a20163ce-7be5-46ec-a50f-a313476b2bd1' , 'localhost:9000/images/a20163ce-7be5-46ec-a50f-a313476b2bd1.jpg', 'температуры', 5.0, 'Наши термометры самые точные в мире!!!! Купи прогноз, не пожалеешь!', '℃', 'valid'),
       ('0706419e-b024-469d-a354-9480cd79c6a5' , 'localhost:9000/images/0706419e-b024-469d-a354-9480cd79c6a5.jpg', 'давления', 4.2, 'Наши манометры самые точные в мире!!!! Купи прогноз, не пожалеешь!', 'мм рт. ст.', 'valid'),
       ('8f157a95-dad1-43e0-9372-93b51de06163' , 'localhost:9000/images/8f157a95-dad1-43e0-9372-93b51de06163.jpg', 'влажности', 6.6, 'Наши гигрометры самые точные в мире!!!! Купи прогноз, не пожалеешь!', '%', 'valid');
